...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	protected void messageReceived(ChannelHandlerContext ctx, FullHttpRequest request) throws Exception {
		...
		setContentTyptHeader(response, file);
		...
		ChannelFuture lastContentFuture = ctx.writeAndFlush(LastHttpContent.EMPTY_LAST_CONTENT);// 一次响应的分割点
		if (!isKeepAlive(request)) {
	...
	private boolean isKeepAlive(FullHttpRequest request) {
		return request.headers().get(HttpHeaderNames.CONNECTION) == HttpHeaderValues.KEEP_ALIVE;
	}

	private void setContentTyptHeader(HttpResponse response, File file) {
		// TODO Auto-generated method stub
